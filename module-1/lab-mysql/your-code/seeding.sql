...
INSERT INTO `lab_mysql`.`Customers` (`ID`, `Customer id`, `Name`, `Phone`, `Address`, `City`, `State/Province`, `Country`, `Postal`) VALUES ('0', '10001', 'Pablo Picasso', '+34 636 17 63 82', 'Paseo de la Chopera, 14', 'Madrid', 'Madrid', 'Spain', '28045');
INSERT INTO `lab_mysql`.`Customers` (`ID`, `Customer id`, `Name`, `Phone`, `Address`, `City`, `State/Province`, `Country`, `Postal`) VALUES ('1', '20001', 'Abraham Lincoln', '+1 305 907 7086', '120 SW 8th St', 'Miami', 'Florida', 'United States', '33130' );
INSERT INTO `lab_mysql`.`Customers` (`ID`, `Customer id`, `Name`, `Phone`, `Address`, `City`, `State/Province`, `Country`, `Postal`) VALUES ('2', '30001', 'Napoléon Bonaparte', '+33 1 79 75 40 00', '40 Rue du Colisée', 'Paris', 'Île-de-France', 'France', '75008');
...
INSERT INTO `lab_mysql`.`Invoices` (`ID`, `Invoice Number`, `Date`, `Car`, `Customer`, `Sales Person`) VALUES ('0', '852399038', '2018-08-22', '0', '1', '3');
INSERT INTO `lab_mysql`.`Invoices` (`ID`, `Invoice Number`, `Date`, `Car`, `Customer`, `Sales Person`) VALUES ('1', '731166526', '2018-12-31', '3', '0', '5');
INSERT INTO `lab_mysql`.`Invoices` (`ID`, `Invoice Number`, `Date`, `Car`, `Customer`, `Sales Person`) VALUES ('2', '271135104', '2019-01-22', '2', '2', '7');
